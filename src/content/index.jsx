...
const Index = () => {
  const [selected, setSelected] = useState("hoten");
  ...
  return (
    <div className="pl-[5vw] pr-[5vw] md:pl-[18vw] md:pr-[18vw] flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-1 md:w-[50%] w-full justify-center items-center self-center">
          <Input
            type="text"
          ...
          />
          <Button
            isDisabled={selected === "cccd" && !query}
            color="primary"
            onClick={() => {
              setCondition(query);
              setHidden(true);
        ...
        {!hidden && (
          <>
            <div className="flex flex-col gap-2 self-center md:w-[50%] w-full">
              ...
              <p className="font-semibold">* Tìm kiếm theo Họ và tên:</p>
              <p>- Bước 1: Trong mục Tra cứu theo: bạn chọn mục Họ và tên</p>
              <p>- Bước 2: Gõ đầy đủ Họ và tên cần tìm vào ô tìm kiếm .</p>
              <p>- Bước 3: Ấn vào nút Tìm kiếm</p>
              <p className="font-semibold">* Tìm kiếm theo CCCD/CMT:</p>
              <p>- Bước 1: Trong mục tra cứu theo: bạn chọn mục CCCD/CMT</p>
              <p>- Bước 2: Gõ đầy đủ CCCD/CMT cần tìm vào ô tìm kiếm .</p>
              <p>- Bước 3: Ấn vào nút Tìm kiếm</p>
            </div>
